...
namespace SOHNE.Accessibility.Colorblindness
{
    ...
    public class Colorblindness : MonoBehaviour
    {
		...
		public void ChangeToProtanopia()
		{
			currentType = 1;
			PlayerPrefs.SetInt("Accessibility.ColorblindType", currentType);
			InitChange();
		}
		public void ChangeToProtanomaly()
		{
			currentType = 2;
			PlayerPrefs.SetInt("Accessibility.ColorblindType", currentType);
			InitChange();
		}
		public void ChangeToDeuteranopia()
		{
			currentType = 3;
			PlayerPrefs.SetInt("Accessibility.ColorblindType", currentType);
			InitChange();
		}
		public void ChangeToDeuteranomaly()
		{
			currentType = 4;
			PlayerPrefs.SetInt("Accessibility.ColorblindType", currentType);
			InitChange();
		}
		public void ChangeToTritanopia()
		{
			currentType = 5;
			PlayerPrefs.SetInt("Accessibility.ColorblindType", currentType);
			InitChange();
		}
		public void ChangeToTritanomaly()
		{
			currentType = 6;
			PlayerPrefs.SetInt("Accessibility.ColorblindType", currentType);
			InitChange();
		}
		public void ChangeToAchromatopsia()
		{
			currentType = 7;
			PlayerPrefs.SetInt("Accessibility.ColorblindType", currentType);
			InitChange();
		}
		public void ChangeToAchromatomaly()
		{
			currentType = 8;
			PlayerPrefs.SetInt("Accessibility.ColorblindType", currentType);
			InitChange();
